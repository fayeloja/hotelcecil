      ...
      <div className="border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
            Order your copy of "No Better Address!" and discover the untold stories 
            of the Hotel Cecil, Tangier.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-amber-400 transition-colors">About the Book</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">The Authors</a></li>
              <li><a href="#" className="hover:text-amber-400 transition-colors">Photo Gallery</a></li>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-amber-600 flex items-center justify-center transition-colors">
                <Facebook size={20} />
              </a>
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-amber-600 flex items-center justify-center transition-colors">
                <Twitter size={20} />
            ...
            <p className="text-gray-400 text-sm">
              For inquiries, interviews, or speaking engagements, please contact us at:
            </p>
            <a href="mailto:contact@nobetteraddress.com" className="text-amber-400 hover:text-amber-300 text-sm">
